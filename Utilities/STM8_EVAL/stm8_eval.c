...
#include "STM8L1526_EVAL/stm8l1526_eval.c"      /* SDCC patch: change to upper-case to match path */
#elif defined USE_STM8L1528_EVAL
#include "STM8L1528_EVAL/stm8l1528_eval.c"      /* SDCC patch: change to upper-case to match path */
#else
